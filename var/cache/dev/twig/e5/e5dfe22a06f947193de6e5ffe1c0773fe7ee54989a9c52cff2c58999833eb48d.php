...
class __TwigTemplate_bc78d4a09a3c3440956c262bc9ca8a8362230a3e8c5f3d8d3594abc189b8c01b extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        <tbody>
            <tr>
                ...
                <td>";
        // line 12
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["comment"] ?? null), "commentary", [], "any", false, false, false, 12), "html", null, true);
        echo "</td>
            </tr>
            <tr>
                <th>Grade</th>
                <td>";
        // line 16
        echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["comment"] ?? null), "grade", [], "any", false, false, false, 16), "html", null, true);
        echo "</td>
            </tr>
        </tbody>
    </table>
    ...
    <a href=\"";
        // line 23
        echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("comment_edit", ["id" => twig_get_attribute($this->env, $this->source, ($context["comment"] ?? null), "id", [], "any", false, false, false, 23)]), "html", null, true);
        echo "\">edit</a>
...
";
    ...
    {
        return array (  103 => 25,  98 => 23,  93 => 21,  85 => 16,  78 => 12,  68 => 4,  58 => 3,  35 => 1,);
    }
...
{% endblock %}
", "comment/show.html.twig", "/home/serandour/AgVoyFin/AgVoy-Fin/templates/comment/show.html.twig");
    }
}
