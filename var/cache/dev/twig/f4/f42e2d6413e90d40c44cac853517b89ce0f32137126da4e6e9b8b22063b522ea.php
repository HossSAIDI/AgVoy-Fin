...
class __TwigTemplate_15dbee98e7b10dc7c85192b0210aa43e8cef8994456b8f4f599de381af1b8c95 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
        ...
        <div class=\"sf-toolbar-info-piece\">
            ...
            <span>";
        // line 19
        (((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "memoryLimit", [], "any", false, false, false, 19) ==  -1)) ? (print ("Unlimited")) : (print (twig_escape_filter($this->env, sprintf("%.0f MB", ((twig_get_attribute($this->env, $this->source, ($context["collector"] ?? null), "memoryLimit", [], "any", false, false, false, 19) / 1024) / 1024)), "html", null, true))));
        echo "</span>
        </div>
    ";
...
{% endblock %}
", "@WebProfiler/Collector/memory.html.twig", "/home/serandour/AgVoyFin/AgVoy-Fin/vendor/symfony/web-profiler-bundle/Resources/views/Collector/memory.html.twig");
    }
}
