...
";
    ...
    {
        return new Source("<form method=\"post\" action=\"{{ path('reservation_delete', {'id': reservation.id}) }}\" onsubmit=\"return confirm('Are you sure you want to delete this item?');\">
    <input type=\"hidden\" name=\"_method\" value=\"DELETE\">
    <input type=\"hidden\" name=\"_token\" value=\"{{ csrf_token('delete' ~ reservation.id) }}\">
    <button class=\"btn\">Delete</button>
</form>
", "reservation/_delete_form.html.twig", "/home/houssem_saidi/CSC4101/AgVoy/templates/reservation/_delete_form.html.twig");
    }
}
