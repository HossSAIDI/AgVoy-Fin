...
class __TwigTemplate_ecd87a4088f26a8d6b991c30ef74fa17ae09c3dcdc02e0675e7436aeb82e91f3 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    public function block_body($context, array $blocks = [])
    {
        ...
        // line 6
        echo "<h2>Here are your reservations!</h2>
<ul>
   ";
        // line 8
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["reservation"]) {
            // line 9
            echo "<li>";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reservation"], "id", [], "any", false, false, false, 9), "html", null, true);
            echo "</li>
<li>";
            // line 10
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reservation"], "beginDate", [], "any", false, false, false, 10), "html", null, true);
            echo "</li>
<li>";
            // line 11
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["reservation"], "endDate", [], "any", false, false, false, 11), "html", null, true);
            echo "</li>
<li><a href=\"";
            // line 12
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath("reservation_edit", ["id" => twig_get_attribute($this->env, $this->source, $context["reservation"], "id", [], "any", false, false, false, 12)]), "html", null, true);
            echo "\" >Edit Reservation</a></li>
<li> </li>
...
";
    ...
    {
        return array (  119 => 16,  109 => 12,  105 => 11,  101 => 10,  96 => 9,  92 => 8,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
<li>{{ reservation.beginDate }}</li>
<li>{{ reservation.endDate }}</li>
<li><a href=\"{{ path('reservation_edit', {'id': reservation.id}) }}\" >Edit Reservation</a></li>
<li> </li>
