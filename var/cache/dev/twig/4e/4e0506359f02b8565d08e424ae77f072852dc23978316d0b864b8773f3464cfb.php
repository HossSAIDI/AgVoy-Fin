...
class __TwigTemplate_7192fbd3660e77dc371bd0635cc17ed1e74bcd19d2d72daf77079ffddee8b61f extends \Twig\Template
{
    private $source;
    private $macros = [];
        ...
        if ((isset($context["templates"]) || array_key_exists("templates", $context))) {
            ...
            foreach ($context['_seq'] as $context["name"] => $context["template"]) {
                ...
                if (                $this->loadTemplate($context["template"], "@WebProfiler/Profiler/layout.html.twig", 119)->hasBlock("menu", $context)) {
                    // line 120
                    $__internal_f607aeef2c31a95a7bf963452dff024ffaeb6aafbe4603f9ca3bec57be8633f4 = ["collector" => twig_get_attribute($this->env, $this->source, ($context["profile"] ?? null), "getcollector", [0 => $context["name"]], "method", false, false, false, 120), "profiler_markup_version" => ($context["profiler_markup_version"] ?? null)];
            ...
            if ((($context["request_collector"] ?? null) && twig_get_attribute($this->env, $this->source, ($context["request_collector"] ?? null), "redirect", [], "any", false, false, false, 27))) {
                ...
                echo "</span>
                                ...
                                <dd>
                                    ";
                // line 37
                ((("GET" != twig_get_attribute($this->env, $this->source, ($context["redirect"] ?? null), "method", [], "any", false, false, false, 37))) ? (print (twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, ($context["redirect"] ?? null), "method", [], "any", false, false, false, 37), "html", null, true))) : (print ("")));
                echo "
                                    ";
                // line 38
...
{% endblock %}
", "@WebProfiler/Profiler/layout.html.twig", "/home/serandour/AgVoyFin/AgVoy-Fin/vendor/symfony/web-profiler-bundle/Resources/views/Profiler/layout.html.twig");
    }
}
