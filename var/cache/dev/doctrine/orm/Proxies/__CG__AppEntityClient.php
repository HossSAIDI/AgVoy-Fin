...
class Client extends \App\Entity\Client implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'id', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'firstname', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'familyName', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'email', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'gender', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'country', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'phoneNumber', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'reservations', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'comments', '' . "\0" . 'App\\Entity\\Client' . "\0" . 'user'];
        }
     ...
     * {@inheritDoc}
     */
    public function setFamilyName(string $familyName): \App\Entity\Client
    {
     ...
     * {@inheritDoc}
     */
    public function setGender(?string $gender): \App\Entity\Client
    {
     ...
     * {@inheritDoc}
     */
    public function setPhoneNumber(?string $phoneNumber): \App\Entity\Client
    {
     ...
     * {@inheritDoc}
     */
    public function addComment(\App\Entity\Comment $comment): \App\Entity\Client
    {
     ...
     * {@inheritDoc}
     */
    public function removeComment(\App\Entity\Comment $comment): \App\Entity\Client
    {
