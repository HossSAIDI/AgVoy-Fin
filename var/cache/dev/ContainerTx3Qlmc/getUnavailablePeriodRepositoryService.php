...
// Returns the private 'App\Repository\UnavailablePeriodRepository' shared autowired service.
...
include_once $this->targetDirs[3].'/src/Repository/UnavailablePeriodRepository.php';

return $this->privates['App\\Repository\\UnavailablePeriodRepository'] = new \App\Repository\UnavailablePeriodRepository(($this->services['doctrine'] ?? $this->getDoctrineService()));
