...
class srcApp_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            'App\\Controller\\BackofficeRegionController' => 'getBackofficeRegionControllerService.php',
            ...
            'App\\Controller\\RoomsParRegion' => 'getRoomsParRegionService.php',
        ...
        $this->privates['service_container'] = function () {
            ...
            include_once $this->targetDirs[3].'/vendor/camurphy/bootstrap-menu-bundle/Twig/Extension/MenuExtension.php';
    ...
    protected function getTwigService()
    {
        ...
        $a->addPath(($this->targetDirs[3].'/vendor/symfony/web-profiler-bundle/Resources/views'), '!WebProfiler');
        $a->addPath(($this->targetDirs[3].'/vendor/camurphy/bootstrap-menu-bundle/Resources/views'), 'BootstrapMenu');
        $a->addPath(($this->targetDirs[3].'/vendor/camurphy/bootstrap-menu-bundle/Resources/views'), '!BootstrapMenu');
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\AssetExtension(new \Symfony\Component\Asset\Packages(new \Symfony\Component\Asset\PathPackage('/startbootstrap-shop-homepage-gh-pages', new \Symfony\Component\Asset\VersionStrategy\EmptyVersionStrategy(), new \Symfony\Component\Asset\Context\RequestStackContext($c, '', false)), [])));
        ...
        $instance->addExtension(new \Camurphy\BootstrapMenuBundle\Twig\Extension\MenuExtension($this->parameters['bootstrap_menu.menus']));
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = [
                ...
                'BootstrapMenuBundle' => [
                    'path' => ($this->targetDirs[3].'/vendor/camurphy/bootstrap-menu-bundle'),
